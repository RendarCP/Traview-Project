<%@ Page Title="" Language="C#" MasterPageFile="~/PJ_traview/TraviewMaster.master" AutoEventWireup="true" CodeFile="reviewpage.aspx.cs" Inherits="reviewpage" %>
    ...
    <div class="outdiv">
        ...
        <div class="indiv">
            <div style="text-align:left">
                <asp:Label ID="Label1" runat="server" Text="여행후기&amp;팁" Font-Bold="True" Font-Names="한컴 고딕" Font-Size="20pt"></asp:Label>
            </div>
            ...
            <div style="border:1px solid gray">
               <div class="Indivin">
                   <div class="middle">
                <asp:Image ID="Image1" runat="server" Width="1024px" Height="720px"></asp:Image><br />
            ...
            <div style="text-align:left; margin:5px" >
                ...
                <asp:DataList ID="DDlreply" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Both" Width="1000px">
                    ...
                    <ItemTemplate>
                        <div style="text-align:left">                        
                            &nbsp&nbsp&nbsp<asp:Label ID="lblnickname" runat="server" Font-Bold="True" Font-Names="맑은 고딕" Text="" Font-Size="15px" ClientIDMode="AutoID" ForeColor="Black"><%#Eval("nickname") %></asp:Label>
