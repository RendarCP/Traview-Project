...
public partial class QnApage : System.Web.UI.Page
{
    static int no;//글번호
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            articleInfo = myhelper.GetDetailsQnA(bbsInfo.bbsname, no, true);
            ...
            lblKategorie.Text = articleInfo.Kategorie;
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("QnAinput.aspx?id=" + bbsInfo.bbsId + "&md=1&no=" + no);
        }
    }
